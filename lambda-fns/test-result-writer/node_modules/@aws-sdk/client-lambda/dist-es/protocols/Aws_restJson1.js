    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                resolvedPath = __resolvedPath(resolvedPath, input, "LayerName", function () { return input.LayerName; }, "{LayerName}", false);
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                resolvedPath = __resolvedPath(resolvedPath, input, "FunctionName", function () { return input.FunctionName; }, "{FunctionName}", false);
                query = map({
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                resolvedPath = __resolvedPath(resolvedPath, input, "CodeSigningConfigArn", function () { return input.CodeSigningConfigArn; }, "{CodeSigningConfigArn}", false);
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                resolvedPath = __resolvedPath(resolvedPath, input, "UUID", function () { return input.UUID; }, "{UUID}", false);
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
